...
public static partial void LogUserResgistered(this ILogger logger, string username);

[LoggerMessage(
    EventId = 1002,
    Level = LogLevel.Information,
    Message = "User login successded"
)]    
...
[LoggerMessage(
    ...
    Message = "fail login attemp"
)]    
public static partial void LogFailedLoginAttemp(this ILogger logger);
